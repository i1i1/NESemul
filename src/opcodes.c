...
struct opcode ops[256] =
{
	...
	OP(0x98,	op_tya,		NULL,		2,	1)
	OP(0x99,	op_sta,		addr_mode_aby,	5,	3)
	OP(0x9A,	op_txs,		NULL,		2,	1)
	...
	OP(0xA8,	op_tay,		NULL,		2,	1)
	OP(0xA9,	op_lda,		addr_mode_imm,	2,	2)
	OP(0xAA,	op_tax,		NULL,		2,	1)
	...
	OP(0xB8,	op_clv,		NULL,		2,	1)
	OP(0xB9,	op_lda,		addr_mode_aby,	4,	3)
	OP(0xBA,	op_tsx,		NULL,		2,	1)
	...
	OP(0xC8,	op_iny,		NULL,		2,	1)
	OP(0xC9,	op_cmp,		addr_mode_imm,	2,	2)
	OP(0xCA,	op_dex,		NULL,		2,	1)
